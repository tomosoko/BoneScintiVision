...
| 指標 | EXP-007 | EXP-008 (mask) | **EXP-009** | 目標 | 達成 |
|---|---|---|---|---|---|
| Precision | 0.707 | 0.718 | **0.999** | ≥0.900 | ✅ |
| Recall | 0.899 | — | **0.933** | ≥0.800 | ✅ |
| F1 | — | — | **0.965** | — | — |
| 腹部Recall | 0.828 | 0.810 | **0.914** | ≥0.800 | ✅ |
| 頭頸部Recall | — | — | **0.982** | — | — |
| 胸部Recall | — | — | **0.935** | — | — |
| 四肢Recall | — | — | **0.933** | — | — |
| TP / FP / FN | — | — | 686 / 1 / 49 | — | — |
...
**結論:** 生理的集積なし比率を70%→55%に下げることで、Precision が 0.707→0.999 と劇的に改善。
全目標（P≥0.900 + 腹部Recall≥0.800）を同時達成。FP=1 と極めて低く、臨床応用に近い精度を実現。
