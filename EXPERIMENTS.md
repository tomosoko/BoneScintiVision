...
### 中間結果（ep11/150, 2026-04-15）

| 指標 | ep11中間 | EXP-005実績 | 目標 |
|---|---|---|---|
| Precision | 0.948 | 0.980 | ≥0.900 |
| Recall (全体) | 0.770 | 0.818 | ≥0.800 |
| 腹部Recall | 0.667 | 0.757 | **≥0.800** |

*n=50サンプルによる中間評価。訓練初期(7%)のため改善途中。*

### 結果
*(訓練完了後(ep150)に最終検証 `validate_detector_v6.py --n 200` で記入)*
